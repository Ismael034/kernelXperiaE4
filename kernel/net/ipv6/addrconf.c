...
//20150423 MTK'patch for ALPS01964191 begin
...
//20150423 MTK'patch for ALPS01964191 end
...
static void addrconf_rs_timer(unsigned long data)
{
	...
	if (ifp->probes++ < idev->cnf.rtr_solicits) {
		...
		inet6_no_ra_notify(RTM_NORA,idev);    //20150423 MTK'patch for ALPS01964191
		spin_unlock(&ifp->lock);
		/*
		 * Note: we do not support deprecated "all on-link"
		 * assumption any longer.
		 */
		printk("%s: no IPv6 routers present\n", idev->dev->name);    //20150423 MTK'patch for ALPS01964191
	}
