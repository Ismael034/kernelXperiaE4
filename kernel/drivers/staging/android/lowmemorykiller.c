...
/* <<20150115-ChampWang , Ignore logcat , in order to have logcat to analysis issue and for sony do test report,start*/
/*  TODO:It is temporary solution , and need to remove when MTK solution test ok!!!!!!!!!!*/
#ifndef USER_BUILD_KERNEL

		if (!strcmp(p->comm,"logcat"))
        {
            task_unlock(p);
            lowmem_print(1, "Don't kill logcat, %d", __LINE__);
            continue;
        }

#endif
/* >>20150115-ChampWang , Ignore logcat , in order to have logcat to analysis issue and for sony do test report,end*/
